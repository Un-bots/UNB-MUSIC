...
class Config(object):
    ...
    LOGGER_ID = int(getenv("LOGGER_ID", "-1002077082091"))            # make a channel and get its ID
    OWNER_ID = getenv("OWNER_ID", "6253265083")                  # enter your id here

    # optional config variables
    BLACK_IMG = getenv("BLACK_IMG", "https://telegra.ph//file/9b79c4c6da60b8479a160.jpg")        # black image for progress
    BOT_NAME = getenv("BOT_NAME", "\x40\x4d\x75\x73\x69\x63\x5f\x48\x65\x6c\x6c\x42\x6f\x74")   # dont put fancy texts here.
    BOT_PIC = getenv("BOT_PIC", "https://te.legra.ph//file/988729c979a7ac3f70c73.jpg")           # put direct link to image here
